...
**Rates:** $450 – ([Join Wait List]({{ site.waiting_list_url }}))  
...
## Registration
All slots are currently full. Please sign up on our [waiting list]({{ site.waiting_list_url }}) to hear if a slot becomes available.
